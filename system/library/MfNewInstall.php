...
EOF;
    /**
     * A_ROOT.'library/function_tpl.php'
     * @var 模板函数
     */
	private static $function_tpl = <<<EOF
<?php
if(!defined('IN_SYSTEM')) { exit('Access Denied'); }
/**
...
EOF;
    ...
    /**
     * A_ROOT.'library/function_global.php'
     * @var 全局函数
     */
	private static $function_global = <<<EOF
<?php
if(!defined('IN_SYSTEM')) { exit('Access Denied'); }
EOF;
	 ...
	 * 安装
	 */
	public static function MfNewInstall() {
		//新建目录
		...
		!file_exists(A_ROOT.'include'.DIRECTORY_SEPARATOR.'function_global.php') && 
			self::writeFile(A_ROOT.'include'.DIRECTORY_SEPARATOR.'function_global.php', self::$function_global);
		!file_exists(A_ROOT.'include'.DIRECTORY_SEPARATOR.'function_tpl.php') && 
			self::writeFile(A_ROOT.'include'.DIRECTORY_SEPARATOR.'function_tpl.php', self::$function_tpl);
		//heloworld
